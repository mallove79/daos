...
fetch_with_hole6(void **state)
{
	...
	ARRAY_TEST_CASE_CREATE(&ctx, {
		...
		.rec_size = 1,
		.layout = {
			{.data = "", .sel = {1, 3}, .ful = {1, 3}, .is_hole = true},
...
TA("WIP SRV_CSUM_ARRAY18: Hole in middle", fetch_with_hole),
...
TA("WIP SRV_CSUM_ARRAY22: Hole spans past first chunk", fetch_with_hole6),
